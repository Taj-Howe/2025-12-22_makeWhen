...
const CommandPalette: FC<CommandPaletteProps> = ({
  ...
  const handleSubmit = async () => {
    ...
    if (value.parentId) {
      ...
      createArgs.parent_id = selectedProjectId;
    } else if (value.type === "task" && selectedProjectId) {
      createArgs.parent_id = selectedProjectId;
    } else if (value.type !== "project" && !selectedProjectId) {
      setSubmitError("Select a project or provide parent:<id>");
      return;
    }
